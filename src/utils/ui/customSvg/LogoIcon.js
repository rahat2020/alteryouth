export const LogoIcon = ({ bgColor = "white" }) => {
  return (
    <svg
      ...
      color={bgColor}
    >
      <g id="Group_6923" data-name="Group 6923" transform="translate(0 -4)">
        <g id="Group_2" data-name="Group 2" transform="translate(0 24.079)">
